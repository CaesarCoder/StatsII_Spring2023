...
\lstinputlisting[language=R, firstline=46, lastline=74]{PS2.R}
...
\lstinputlisting[language=R, firstline=76, lastline=84]{PS2.R}
% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
...
%		For the policy in which very few countries participate [20 of 192], how does increasing sanctions from 5\% to 15\% change the odds that an individual will support the policy? (Interpretation of a coefficient)
        \lstinputlisting[language=R, firstline=92, lastline=96]{PS2.R}
		...
		\lstinputlisting[language=R, firstline=97, lastline=102]{PS2.R}
		...
		\begin{itemize}
			...
			\lstinputlisting[language=R, firstline=103, lastline=110]{PS2.R}
			% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
			% Date and time: Sat, Feb 18, 2023 - 21:46:39
			\begin{table}[!htbp] \centering 
	    ...
	    \lstinputlisting[language=R, firstline=111, lastline=116]{PS2.R}
		
		
			% Table created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
			% Date and time: Sat, Feb 18, 2023 - 21:44:39
			\begin{table}[!htbp] \centering 
